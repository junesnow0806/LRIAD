...
if os.path.exists(f"statistics/{dataset_name}/auc_appr_list_dp.pkl"):
...
for i, hr in enumerate(hr_range):
    ...
    if not os.path.exists(f"checkpoints/{dataset_name}/guest_bottom_dp_hr{hr}.pth"):
        host_top.train()
        host_bottom.train()
        guest_bottom.train()
        print("training...")
        ...
        torch.save(host_top.state_dict(), f"checkpoints/{dataset_name}/host_top_dp_hr{hr}.pth")
        torch.save(host_bottom.state_dict(), f"checkpoints/{dataset_name}/host_bottom_dp_hr{hr}.pth")
        torch.save(guest_bottom.state_dict(), f"checkpoints/{dataset_name}/guest_bottom_dp_hr{hr}.pth")
        print("training done")
    else:
        host_top.load_state_dict(torch.load(f"checkpoints/{dataset_name}/host_top_dp_hr{hr}.pth"))
        host_bottom.load_state_dict(torch.load(f"checkpoints/{dataset_name}/host_bottom_dp_hr{hr}.pth"))
        guest_bottom.load_state_dict(torch.load(f"checkpoints/{dataset_name}/guest_bottom_dp_hr{hr}.pth"))
    ...
    with open(f"statistics/{dataset_name}/acc_list_dp.pkl", "wb") as f:
        pickle.dump(acc_list, f)
    with open(f"statistics/{dataset_name}/auc_tar_list_dp.pkl", "wb") as f:
        pickle.dump(auc_tar_list, f)
    with open(f"statistics/{dataset_name}/auc_adv_list_dp.pkl", "wb") as f:
        pickle.dump(auc_adv_list, f)
    with open(f"statistics/{dataset_name}/auc_gx_list_dp.pkl", "wb") as f:
        pickle.dump(auc_gx_list, f)
    with open(f"statistics/{dataset_name}/auc_top_list_dp.pkl", "wb") as f:
        pickle.dump(auc_top_list, f)
    with open(f"statistics/{dataset_name}/auc_appr_list_dp.pkl", "wb") as f:
        pickle.dump(auc_appr_list, f)

print(f"defense task of {dataset_name} all done")
